...
public class DuckPuzzleActivity extends AppCompatActivity {

    private static DuckGestureDetectGridView mGridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.puzzle_duck);
        ...
        back.setOnTouchListener((v, event) -> {
            if(event.getAction()== MotionEvent.ACTION_DOWN) {
                ...
                Intent intent = new Intent(DuckPuzzleActivity.this, Puzzle_Images.class);
    ...
    private void init() {
        mGridView = (DuckGestureDetectGridView) findViewById(R.id.layout1);
    ...
    private static void display(Context context) {
        ...
        for (String s : tileList) {
            ...
            switch (s) {
                case "0":
                    button.setBackgroundResource(R.drawable.dc1);
                    break;
                case "1":
                    button.setBackgroundResource(R.drawable.dc2);
                    break;
                case "2":
                    button.setBackgroundResource(R.drawable.dc3);
                    break;
                case "3":
                    button.setBackgroundResource(R.drawable.dc4);
                    break;
                case "4":
                    button.setBackgroundResource(R.drawable.dc5);
                    break;
                case "5":
                    button.setBackgroundResource(R.drawable.dc6);
                    break;
                case "6":
                    button.setBackgroundResource(R.drawable.dc7);
                    break;
                case "7":
                    button.setBackgroundResource(R.drawable.dc8);
                    break;
                case "8":
                    button.setBackgroundResource(R.drawable.dc9);
                    break;
            }
            buttons.add(button);
        }
    ...
    private final class PlayAudioTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            voice = MediaPlayer.create(DuckPuzzleActivity.this, R.raw.puzzle_voice);
            voice.start();
    ...
    private final class PlayAudioClickTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            // Initialize the MediaPlayer and start playing the audio in the background
            click = MediaPlayer.create(DuckPuzzleActivity.this, R.raw.click);
            click.start();
