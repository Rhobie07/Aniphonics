...
public class TigerPuzzleActivity extends AppCompatActivity {

    private static TigerGestureDetectGridView mGridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.puzzle_tiger);
        ...
        back.setOnTouchListener((v, event) -> {
            if(event.getAction()== MotionEvent.ACTION_DOWN) {
                ...
                Intent intent = new Intent(TigerPuzzleActivity.this, Puzzle_Images.class);
    ...
    private void init() {
        mGridView = (TigerGestureDetectGridView) findViewById(R.id.layout4);
    ...
    private static void display(Context context) {
        ...
        for (String s : tileList) {
            ...
            switch (s) {
                case "0":
                    button.setBackgroundResource(R.mipmap.tiger_9);
                    break;
                case "1":
                    button.setBackgroundResource(R.mipmap.tiger_8);
                    break;
                case "2":
                    button.setBackgroundResource(R.mipmap.tiger_7);
                    break;
                case "3":
                    button.setBackgroundResource(R.mipmap.tiger_6);
                    break;
                case "4":
                    button.setBackgroundResource(R.mipmap.tiger_5);
                    break;
                case "5":
                    button.setBackgroundResource(R.mipmap.tiger_4);
                    break;
                case "6":
                    button.setBackgroundResource(R.mipmap.tiger_3);
                    break;
                case "7":
                    button.setBackgroundResource(R.mipmap.tiger_2);
                    break;
                case "8":
                    button.setBackgroundResource(R.mipmap.tiger_1);
                    break;
            }
    ...
    private final class PlayAudioTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            voice = MediaPlayer.create(TigerPuzzleActivity.this, R.raw.puzzle_voice);
            voice.start();
    ...
    private final class PlayAudioClickTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            // Initialize the MediaPlayer and start playing the audio in the background
            click = MediaPlayer.create(TigerPuzzleActivity.this, R.raw.click);
            click.start();
