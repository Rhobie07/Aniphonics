...
public class HamsPuzzleActivity extends AppCompatActivity {

    private static HamsGestureDetectGridView mGridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.puzzle_hamster);
        ...
        back.setOnTouchListener((v, event) -> {
            if(event.getAction()== MotionEvent.ACTION_DOWN) {
                ...
                Intent intent = new Intent(HamsPuzzleActivity.this, Puzzle_Images.class);
    ...
    private void init() {
        mGridView = (HamsGestureDetectGridView) findViewById(R.id.layout6);
    ...
    private static void display(Context context) {
        ...
        for (String s : tileList) {
            ...
            switch (s) {
                case "0":
                    button.setBackgroundResource(R.mipmap.hams_9);
                    break;
                case "1":
                    button.setBackgroundResource(R.mipmap.hams_8);
                    break;
                case "2":
                    button.setBackgroundResource(R.mipmap.hams_7);
                    break;
                case "3":
                    button.setBackgroundResource(R.mipmap.hams_6);
                    break;
                case "4":
                    button.setBackgroundResource(R.mipmap.hams_5);
                    break;
                case "5":
                    button.setBackgroundResource(R.mipmap.hams_4);
                    break;
                case "6":
                    button.setBackgroundResource(R.mipmap.hams_3);
                    break;
                case "7":
                    button.setBackgroundResource(R.mipmap.hams_2);
                    break;
                case "8":
                    button.setBackgroundResource(R.mipmap.hams_1);
                    break;
            }
    ...
    private final class PlayAudioTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            voice = MediaPlayer.create(HamsPuzzleActivity.this, R.raw.puzzle_voice);
            voice.start();
    ...
    private final class PlayAudioClickTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            // Initialize the MediaPlayer and start playing the audio in the background
            click = MediaPlayer.create(HamsPuzzleActivity.this, R.raw.click);
            click.start();
