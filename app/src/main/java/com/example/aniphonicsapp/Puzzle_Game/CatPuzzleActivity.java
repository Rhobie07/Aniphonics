...
public class CatPuzzleActivity extends AppCompatActivity {

    private static CatGestureDetectGridView mGridView;
    ...
    private MediaPlayer voice, click, win;
    private Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.puzzle_cat);
        ...
        back.setOnTouchListener((v, event) -> {
            if(event.getAction()== MotionEvent.ACTION_DOWN) {
                ...
                Intent intent = new Intent(CatPuzzleActivity.this, Puzzle_Images.class);
    ...
    private void init() {
        mGridView = (CatGestureDetectGridView) findViewById(R.id.layout3);
    ...
    private static void display(Context context) {
        ...
        for (String s : tileList) {
            ...
            switch (s) {
                case "0":
                    button.setBackgroundResource(R.mipmap.cat_1);
                    break;
                case "1":
                    button.setBackgroundResource(R.mipmap.cat_2);
                    break;
                case "2":
                    button.setBackgroundResource(R.mipmap.cat_3);
                    break;
                case "3":
                    button.setBackgroundResource(R.mipmap.cat_4);
                    break;
                case "4":
                    button.setBackgroundResource(R.mipmap.cat_5);
                    break;
                case "5":
                    button.setBackgroundResource(R.mipmap.cat_6);
                    break;
                case "6":
                    button.setBackgroundResource(R.mipmap.cat_7);
                    break;
                case "7":
                    button.setBackgroundResource(R.mipmap.cat_8);
                    break;
                case "8":
                    button.setBackgroundResource(R.mipmap.cat_9);
                    break;
            }
    ...
    private final class PlayAudioTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            voice = MediaPlayer.create(CatPuzzleActivity.this, R.raw.puzzle_voice);
            voice.start();
    ...
    private final class PlayAudioClickTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            // Initialize the MediaPlayer and start playing the audio in the background
            click = MediaPlayer.create(CatPuzzleActivity.this, R.raw.click);
            click.start();
    ...
    private final class PlayAudioWinTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            // Initialize the MediaPlayer and start playing the audio in the background
            win = MediaPlayer.create(CatPuzzleActivity.this, R.raw.win_game);
            win.start();
