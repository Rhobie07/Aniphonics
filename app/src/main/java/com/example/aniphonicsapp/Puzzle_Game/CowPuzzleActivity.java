...
public class CowPuzzleActivity extends AppCompatActivity {

    private static CowGestureDetectGridView mGridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.puzzle_cow);
        ...
        back.setOnTouchListener((v, event) -> {
            if(event.getAction()== MotionEvent.ACTION_DOWN) {
                ...
                Intent intent = new Intent(CowPuzzleActivity.this, Puzzle_Images.class);
    ...
    private void init() {
        mGridView = (CowGestureDetectGridView) findViewById(R.id.layout5);
    ...
    private static void display(Context context) {
        ...
        for (String s : tileList) {
            ...
            switch (s) {
                case "0":
                    button.setBackgroundResource(R.mipmap.cow_1);
                    break;
                case "1":
                    button.setBackgroundResource(R.mipmap.cow_2);
                    break;
                case "2":
                    button.setBackgroundResource(R.mipmap.cow_3);
                    break;
                case "3":
                    button.setBackgroundResource(R.mipmap.cow_4);
                    break;
                case "4":
                    button.setBackgroundResource(R.mipmap.cow_5);
                    break;
                case "5":
                    button.setBackgroundResource(R.mipmap.cow_6);
                    break;
                case "6":
                    button.setBackgroundResource(R.mipmap.cow_7);
                    break;
                case "7":
                    button.setBackgroundResource(R.mipmap.cow_8);
                    break;
                case "8":
                    button.setBackgroundResource(R.mipmap.cow_9);
                    break;
            }
    ...
    private final class PlayAudioTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            voice = MediaPlayer.create(CowPuzzleActivity.this, R.raw.puzzle_voice);
            voice.start();
    ...
    private final class PlayAudioClickTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            // Initialize the MediaPlayer and start playing the audio in the background
            click = MediaPlayer.create(CowPuzzleActivity.this, R.raw.click);
            click.start();
